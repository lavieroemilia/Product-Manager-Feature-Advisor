...
PM framework and templates for defining features from opportunity discovery to shaping — grounded in Torres, Cagan, Seiden, Fitzpatrick, Maurya, and Singer.
...
```
/process          → El framework de trabajo y los principios que lo guían
...
Detalle completo en [`/process/framework.md`](./process/framework.md).
