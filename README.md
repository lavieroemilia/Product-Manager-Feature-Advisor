# Product Manager Feature Advisor

PM framework and templates for defining features from opportunity discovery to shaping, grounded in Torres, Cagan, Seiden, Fitzpatrick, Maurya, Singer, Alistair Croll and Benjamin Yoskovitz.
